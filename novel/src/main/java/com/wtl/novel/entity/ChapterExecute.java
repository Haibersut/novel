...
@Entity
@Table(name = "chapter_execute")
public class ChapterExecute {
    ...
    // 构造方法
    public ChapterExecute() {
    }

    public ChapterExecute(Long novelId, String title, int chapterNumber, String content, Integer nowState, String trueId, boolean ownPhoto) {
